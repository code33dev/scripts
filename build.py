...
def build_all_libraries():
    ...
    cmake_args_map = {
        ...
        #"freetype": ["-DFT_REQUIRE_ZLIB=TRUE  -DFT_REQUIRE_BZIP2=TRUE -DFT_REQUIRE_PNG=TRUE -DFT_REQUIRE_HARFBUZZ=TRUE -D FT_REQUIRE_BROTLI=TRUE -DWITH_HARFBUZZ=ON -DWITH_BROTLI=ON -DWITH_BZIP2=ON -DBUILD_SHARED_LIBS=false -DCMAKE_INSTALL_PREFIX=../../sdk"],
